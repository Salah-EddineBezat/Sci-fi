...
<body>
  ...
  <h1 class="firstTitle">Resultaat:</h1>

  <main>
    <!-- Uitleg escaperoom -->
    <div class="contentResult">
      <h2 class="titleCenter">Resultaat</h2>
      <p>Hier komt het resultaat
        <br>
        <span class="green">Succesvol</span> of <span class="red">Niet succesvol</span>
        <br>
        Score
      </p>
    </div>
